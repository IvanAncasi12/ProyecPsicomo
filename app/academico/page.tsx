...
export default function AcademicoPage() {
  const opciones = [
    { titulo: 'Cursos', href: '/academico/cursos', desc: 'Talleres y capacitaciones continuas' },
    { titulo: 'Seminarios', href: '/academico/seminarios', desc: 'Espacios de debate y especialización' },
    { titulo: 'Convocatorias', href: '/academico/convocatorias', desc: 'Llamados oficiales y oportunidades' },
    { titulo: 'Ofertas Académicas', href: '/academico/ofertas-academicas', desc: 'Programas de admisión y estudio' },
    { titulo: 'Gacetas', href: '/academico/gacetas', desc: 'Publicaciones y normativas institucionales' },
  ]
